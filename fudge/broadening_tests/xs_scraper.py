...
processed_GNDS_name = f'{isotope[0]}-{periodictable.elements[isotope[0]]}-{isotope[1]}g.proc.xml' # name of the processed GNDS file only
processed_GNDS_master_directory = f'/Users/rntg/PycharmProjects/ResonanceML/fudge/heated_gnds' # location of processed GNDS file


# This directory will be generated by FUDGE after reading cross sections
...
# Fetches and reads temperatures for processing using terminal (change directory address)
